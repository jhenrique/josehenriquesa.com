  ...
  const dict = {
    en: {
      ...
      home: {
        ...
        contactText: 'Open to opportunities of collaboration.',
      ...
      contact: {
        ...
        heroSub: 'Open to partnerships of collaborations.',
    ...
    es: {
      ...
      home: {
        ...
        contactLabel: '// 06 — Contacto', contactTitle: 'Vamos a<br><span class="stroke-text">Conversar</span>', contactText: 'Abierto a oportunidades de colaboraciones. Respondo en hasta 24 horas.', contactLocation: 'São Paulo, SP · Brasil', sendMessage: 'Enviar mensaje →', footerEmail: 'Email'
      },
      contact: {
    ...
    pt: {
      ...
      home: {
        ...
        contactLabel: '// 06 — Contato', contactTitle: 'Vamos<br><span class="stroke-text">Conversar</span>', contactText: 'Aberto a oportunidades de colaboração.', contactLocation: 'São Paulo, SP · Brasil', sendMessage: 'Enviar mensagem →', footerEmail: 'Email'
      },
      contact: {
